 ...
 * apibuilder 0.14.75 app.apibuilder.io/paintbatch-com/paint-batch-optimizer/1.0.0/http4s_0_20
 */
package com.paintbatch.models {
   ...
   * 
   * @param numberOfPaints number of paints
...
package com.paintbatch.models {
  ...
  package object json {
    ...
    implicit def decodePaintBatchOptimizerDemand: Decoder[Demand] = Decoder.instance { c =>
     for {
        numberOfPaints <- c.downField("numberOfPaints").as[Int]
    ...
    implicit def encodePaintBatchOptimizerDemand: Encoder[Demand] = Encoder.instance { t =>
      Json.fromFields(Seq(
        Some("numberOfPaints" -> t.numberOfPaints.asJson),
...
import io.circe.syntax._
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.14.75 app.apibuilder.io/paintbatch-com/paint-batch-optimizer/1.0.0/http4s_0_20"
    val Version = "1.0.0"
    val VersionMajor = 1
